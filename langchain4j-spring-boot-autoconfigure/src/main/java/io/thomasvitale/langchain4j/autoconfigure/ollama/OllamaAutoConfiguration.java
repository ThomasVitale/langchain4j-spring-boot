...
@EnableConfigurationProperties({OllamaProperties.class, OllamaChatProperties.class,
...
public class OllamaAutoConfiguration {
    ...
    OllamaStreamingChatModel ollamaStreamingChatModel(OllamaProperties ollamaProperties, OllamaChatProperties ollamaChatProperties) {
    ...
    OllamaEmbeddingModel ollamaEmbeddingModel(OllamaProperties ollamaProperties, OllamaEmbeddingProperties ollamaEmbeddingProperties) {
